...
mixin _$ProjectGlossaryWordsRequest {
 ...
 String get projectKey; List<String> get words;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProjectGlossaryWordsRequest&&(identical(other.projectKey, projectKey) || other.projectKey == projectKey)&&const DeepCollectionEquality().equals(other.words, words));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,projectKey,const DeepCollectionEquality().hash(words));

@override
String toString() {
  return 'ProjectGlossaryWordsRequest(projectKey: $projectKey, words: $words)';
}
...
@useResult
$Res call({
 String projectKey, List<String> words
});
...
/// Create a copy of ProjectGlossaryWordsRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? projectKey = null,Object? words = null,}) {
...
class _ProjectGlossaryWordsRequest implements ProjectGlossaryWordsRequest {
  const _ProjectGlossaryWordsRequest({required this.projectKey, required  List<String> words}): _words = words;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ProjectGlossaryWordsRequest&&(identical(other.projectKey, projectKey) || other.projectKey == projectKey)&&const DeepCollectionEquality().equals(other._words, _words));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,projectKey,const DeepCollectionEquality().hash(_words));
...
/// Create a copy of ProjectGlossaryWordsRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? projectKey = null,Object? words = null,}) {
