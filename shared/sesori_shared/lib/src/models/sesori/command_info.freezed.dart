...
bool operator ==(Object other) {
  final _this = this as CommandInfo;
...
String toString() {
  final _this = this as CommandInfo;
  return 'CommandInfo(name: ${_this.name}, template: ${_this.template}, hints: ${_this.hints}, description: ${_this.description}, agent: ${_this.agent}, model: ${_this.model}, provider: ${_this.provider}, source: ${_this.source}, subtask: ${_this.subtask})';
}
