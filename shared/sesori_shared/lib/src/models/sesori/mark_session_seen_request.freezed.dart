...
mixin _$MarkSessionSeenRequest {
 ...
 String get sessionId; bool get read;
...
/// Create a copy of MarkSessionSeenRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? sessionId = null,Object? read = null,}) {
  return _then(MarkSessionSeenRequest(
...
class _MarkSessionSeenRequest implements MarkSessionSeenRequest {
  const _MarkSessionSeenRequest({required this.sessionId, required this.read});
...
/// Create a copy of MarkSessionSeenRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? sessionId = null,Object? read = null,}) {
