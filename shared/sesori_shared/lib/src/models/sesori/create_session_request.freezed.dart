...
mixin _$CreateSessionRequest {
 ...
 String get projectId; List<PromptPart> get parts; String? get agent; PromptModel? get model; WorktreeMode get worktreeMode; String? get selectedBranch;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CreateSessionRequest&&(identical(other.projectId, projectId) || other.projectId == projectId)&&const DeepCollectionEquality().equals(other.parts, parts)&&(identical(other.agent, agent) || other.agent == agent)&&(identical(other.model, model) || other.model == model)&&(identical(other.worktreeMode, worktreeMode) || other.worktreeMode == worktreeMode)&&(identical(other.selectedBranch, selectedBranch) || other.selectedBranch == selectedBranch));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,projectId,const DeepCollectionEquality().hash(parts),agent,model,worktreeMode,selectedBranch);

@override
String toString() {
  return 'CreateSessionRequest(projectId: $projectId, parts: $parts, agent: $agent, model: $model, worktreeMode: $worktreeMode, selectedBranch: $selectedBranch)';
}
...
@useResult
$Res call({
 String projectId, List<PromptPart> parts, String? agent, PromptModel? model, WorktreeMode worktreeMode, String? selectedBranch
});
...
/// Create a copy of CreateSessionRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? projectId = null,Object? parts = null,Object? agent = freezed,Object? model = freezed,Object? worktreeMode = null,Object? selectedBranch = freezed,}) {
...
as PromptModel?,worktreeMode: null == worktreeMode ? _self.worktreeMode : worktreeMode // ignore: cast_nullable_to_non_nullable
as WorktreeMode,selectedBranch: freezed == selectedBranch ? _self.selectedBranch : selectedBranch // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
/// Create a copy of CreateSessionRequest
...
class _CreateSessionRequest implements CreateSessionRequest {
  const _CreateSessionRequest({required this.projectId, required final  List<PromptPart> parts, required this.agent, required this.model, required this.worktreeMode, required this.selectedBranch}): _parts = parts;
...
@override final  WorktreeMode worktreeMode;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,projectId,const DeepCollectionEquality().hash(_parts),agent,model,worktreeMode,selectedBranch);
...
/// Create a copy of CreateSessionRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? projectId = null,Object? parts = null,Object? agent = freezed,Object? model = freezed,Object? worktreeMode = null,Object? selectedBranch = freezed,}) {
