...
_PluginMetadata _$PluginMetadataFromJson(Map json) => _PluginMetadata(
  ...
  state: $enumDecode(_$PluginLifecycleStateEnumMap, json['state']),
  actionHint: json['actionHint'] as String?,
);

Map<String, dynamic> _$PluginMetadataToJson(_PluginMetadata instance) => <String, dynamic>{
  'id': instance.id,
...
_PluginListResponse _$PluginListResponseFromJson(Map json) => _PluginListResponse(
...
Map<String, dynamic> _$PluginListResponseToJson(_PluginListResponse instance) => <String, dynamic>{
