...
class MessagePartTool extends MessagePart {
  const MessagePartTool({required this.id, required this.sessionID, required this.messageID, this.tool = "", this.state = const ToolState(status: ToolStatus.pending, shellCommand: null, output: null, error: null),  String? $type}): $type = $type ?? 'tool',super._();
...
@JsonKey(unknownEnumValue: ToolStatus.unknown) ToolStatus get status; String? get shellCommand; String? get output; String? get error;@JsonKey(fromJson: _messageAttachmentsFromJson) List<MessageAttachment> get attachments;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,status,shellCommand,output,error,const DeepCollectionEquality().hash(attachments));

@override
String toString() {
  return 'ToolState(status: $status, shellCommand: $shellCommand, output: $output, error: $error, attachments: $attachments)';
}
...
@useResult
$Res call({
@JsonKey(unknownEnumValue: ToolStatus.unknown) ToolStatus status, String? shellCommand, String? output, String? error,@JsonKey(fromJson: _messageAttachmentsFromJson) List<MessageAttachment> attachments
});
...
/// Create a copy of ToolState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? shellCommand = freezed,Object? output = freezed,Object? error = freezed,Object? attachments = null,}) {
  return _then(ToolState(
status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as ToolStatus,shellCommand: freezed == shellCommand ? _self.shellCommand : shellCommand // ignore: cast_nullable_to_non_nullable
...
class _ToolState implements ToolState {
  const _ToolState({@JsonKey(unknownEnumValue: ToolStatus.unknown) required this.status, this.shellCommand = null, required this.output, required this.error, @JsonKey(fromJson: _messageAttachmentsFromJson)  List<MessageAttachment> attachments = const <MessageAttachment>[]}): _attachments = attachments;
...
@override@JsonKey() final  String? shellCommand;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,status,shellCommand,output,error,const DeepCollectionEquality().hash(_attachments));
...
/// Create a copy of ToolState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? shellCommand = freezed,Object? output = freezed,Object? error = freezed,Object? attachments = null,}) {
