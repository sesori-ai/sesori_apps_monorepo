...
class _ProviderInfo implements ProviderInfo {
  const _ProviderInfo({required this.id, required this.name, required  Map<String, ProviderModel> models, required this.defaultModelID}): _models = models;
...
class _ProviderModel implements ProviderModel {
  const _ProviderModel({required this.id, required this.providerID, required this.name, required  List<String> variants, required this.family, this.isAvailable = true, @dateConverter required this.releaseDate}): _variants = variants;
...
@pragma('vm:prefer-inline') @override $Res call({Object? items = null,Object? connectedOnly = null,}) {
  return _then(ProviderListResponse(
...
class _ProviderListResponse implements ProviderListResponse {
  const _ProviderListResponse({required  List<ProviderInfo> items, required this.connectedOnly}): _items = items;
