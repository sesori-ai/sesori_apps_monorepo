...
class SesoriPluginInstallProgress implements SesoriSseEvent {
  const SesoriPluginInstallProgress({required this.pluginId, @JsonKey(unknownEnumValue: PluginRuntimeProvisionKind.unknown) this.operation = PluginRuntimeProvisionKind.managedInstall, @JsonKey(unknownEnumValue: PluginInstallPhase.unknown) required this.phase, required this.percent, required this.message,  String? $type}): $type = $type ?? 'plugin.install.progress';
  factory SesoriPluginInstallProgress.fromJson(Map<String, dynamic> json) => _$SesoriPluginInstallProgressFromJson(json);

 final  String pluginId;
@JsonKey(unknownEnumValue: PluginRuntimeProvisionKind.unknown) final  PluginRuntimeProvisionKind operation;
...
@override
int get hashCode {
    return Object.hash(runtimeType,pluginId,operation,phase,percent,message);
}

@override
String toString() {
    return 'SesoriSseEvent.pluginInstallProgress(pluginId: $pluginId, operation: $operation, phase: $phase, percent: $percent, message: $message)';
}
...
@useResult
$Res call({
 String pluginId,@JsonKey(unknownEnumValue: PluginRuntimeProvisionKind.unknown) PluginRuntimeProvisionKind operation,@JsonKey(unknownEnumValue: PluginInstallPhase.unknown) PluginInstallPhase phase, int? percent, String? message
});
...
/// Create a copy of SesoriSseEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? pluginId = null,Object? operation = null,Object? phase = null,Object? percent = freezed,Object? message = freezed,}) {
...
as PluginRuntimeProvisionKind,phase: null == phase ? _self.phase : phase // ignore: cast_nullable_to_non_nullable
