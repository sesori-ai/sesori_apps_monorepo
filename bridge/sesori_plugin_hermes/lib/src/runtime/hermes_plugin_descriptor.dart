...
import "package:sesori_bridge_foundation/sesori_bridge_foundation.dart"
    show CommandResult, HostProcessCommandExecutor, IoHostExecutableLocator, SemanticVersion, stripAnsi;
  ...
  Future<PluginSetupStatus> inspectSetup({
    ...
    switch (runtime) {
      ...
      case _HermesRuntimeOutdated(:final version):
        ...
        return const PluginSetupUnavailable(
          actionHint:
              "The configured Hermes CLI path points to an unsupported version. "
              "Update that install or fix `--hermes-bin`.",
        );
