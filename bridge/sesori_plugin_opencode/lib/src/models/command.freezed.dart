...
mixin _$Command {
 ...
 String get name;@JsonKey(readValue: _readTemplate) String? get template; List<String> get hints; String? get description; String? get agent; String? get model; String? get provider;@JsonKey(unknownEnumValue: CommandSource.unknown) CommandSource? get source; bool? get subtask;
...
@override
String toString() {
  return 'Command(name: $name, template: $template, hints: $hints, description: $description, agent: $agent, model: $model, provider: $provider, source: $source, subtask: $subtask)';
}
...
@useResult
$Res call({
 String name,@JsonKey(readValue: _readTemplate) String? template, List<String> hints, String? description, String? agent, String? model, String? provider,@JsonKey(unknownEnumValue: CommandSource.unknown) CommandSource? source, bool? subtask
});
...
class _Command implements Command {
  const _Command({required this.name, @JsonKey(readValue: _readTemplate) this.template, final  List<String> hints = const <String>[], this.description, this.agent, this.model, required this.provider, @JsonKey(unknownEnumValue: CommandSource.unknown) this.source, this.subtask}): _hints = hints;
