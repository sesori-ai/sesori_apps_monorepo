...
class EventWorktreeReady implements Event {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || (other is EventWorktreeReady && other.id == id && other.properties == properties);
...
class EventWorktreeReadyProperties {
  ...
  @override
  bool operator ==(Object other) =>
      identical(this, other) || (other is EventWorktreeReadyProperties && other.name == name && other.branch == branch);
