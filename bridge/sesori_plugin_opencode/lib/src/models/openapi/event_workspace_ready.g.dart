...
class EventWorkspaceReady implements Event {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || (other is EventWorkspaceReady && other.id == id && other.properties == properties);
...
class EventWorkspaceReadyProperties {
  ...
  @override
  bool operator ==(Object other) =>
      identical(this, other) || (other is EventWorkspaceReadyProperties && other.name == name);
