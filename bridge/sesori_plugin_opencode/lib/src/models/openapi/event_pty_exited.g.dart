...
class EventPtyExited implements Event {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || (other is EventPtyExited && other.id == id && other.properties == properties);
...
class EventPtyExitedProperties {
  ...
  @override
  bool operator ==(Object other) =>
      identical(this, other) || (other is EventPtyExitedProperties && other.id == id && other.exitCode == exitCode);
