...
const String ownerOnlyDirectoryMode = "700";
const String ownerOnlyFileMode = "600";
...
void hardenPathSync({required String targetPath, required String mode}) {
  ...
  if (result.exitCode != 0) throw FileSystemException("Failed to set mode $mode", targetPath);
}
