...
_GrokModelMetadataDto _$GrokModelMetadataDtoFromJson(Map json) => _GrokModelMetadataDto(
...
_GrokSessionModelStateDto _$GrokSessionModelStateDtoFromJson(Map json) => _GrokSessionModelStateDto(
  availableModels:
...
_GrokInitializeMetadataDto _$GrokInitializeMetadataDtoFromJson(Map json) => _GrokInitializeMetadataDto(
...
_GrokModelStateEnvelopeDto _$GrokModelStateEnvelopeDtoFromJson(Map json) => _GrokModelStateEnvelopeDto(
  metadata: json['_meta'] == null
      ? null
