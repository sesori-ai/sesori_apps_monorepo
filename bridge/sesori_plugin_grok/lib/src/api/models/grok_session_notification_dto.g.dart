...
_GrokSessionNotificationDto _$GrokSessionNotificationDtoFromJson(Map json) => _GrokSessionNotificationDto(
...
GrokSubagentSpawned _$GrokSubagentSpawnedFromJson(Map json) => GrokSubagentSpawned(
...
GrokSubagentProgress _$GrokSubagentProgressFromJson(Map json) => GrokSubagentProgress(
  subagentId: json['subagent_id'] as String,
  $type: json['sessionUpdate'] as String?,
);

GrokSubagentFinished _$GrokSubagentFinishedFromJson(Map json) => GrokSubagentFinished(
  subagentId: json['subagent_id'] as String,
  childSessionId: json['child_session_id'] as String,
  status: $enumDecode(
...
_GrokToolCallMetaDto _$GrokToolCallMetaDtoFromJson(Map json) => _GrokToolCallMetaDto(
...
_GrokToolIdentityDto _$GrokToolIdentityDtoFromJson(Map json) => _GrokToolIdentityDto(
