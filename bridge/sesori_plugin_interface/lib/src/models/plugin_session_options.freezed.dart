...
class _PluginSessionOptions implements PluginSessionOptions {
  const _PluginSessionOptions({required final  List<PluginAgent> agents, required this.providers, required final  List<PluginCommand> commands, required this.completeness}): _agents = agents,_commands = commands;
