...
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? activeSessions = null,}) {
  return _then(PluginProjectActivitySummary(
...
class _PluginProjectActivitySummary implements PluginProjectActivitySummary {
  const _PluginProjectActivitySummary({required this.id, required  List<PluginActiveSession> activeSessions}): _activeSessions = activeSessions;
