...
Map<String, dynamic> _$PluginModelToJson(_PluginModel instance) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
...
Map<String, dynamic> _$PluginProviderToJson(_PluginProvider instance) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
