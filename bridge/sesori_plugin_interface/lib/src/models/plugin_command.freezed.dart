...
class _PluginCommand implements PluginCommand {
  const _PluginCommand({required this.name, required this.template, required final  List<String> hints, this.description, this.agent, this.model, this.source, this.subtask}): _hints = hints;
