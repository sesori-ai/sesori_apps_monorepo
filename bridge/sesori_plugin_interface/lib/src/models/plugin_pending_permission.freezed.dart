...
/// child/sub-agent session's request). Null when unknown.
 String? get displaySessionId; String get tool; String get description; PluginPermissionDetails get details; bool get allowAlways;
...
int get hashCode {
  final _this = this as PluginPendingPermission;
  return Object.hash(runtimeType,_this.id,_this.sessionID,_this.displaySessionId,_this.tool,_this.description,_this.details,_this.allowAlways);
}

@override
String toString() {
  final _this = this as PluginPendingPermission;
  return 'PluginPendingPermission(id: ${_this.id}, sessionID: ${_this.sessionID}, displaySessionId: ${_this.displaySessionId}, tool: ${_this.tool}, description: ${_this.description}, details: ${_this.details}, allowAlways: ${_this.allowAlways})';
}
...
@useResult
$Res call({
 String id, String sessionID, String? displaySessionId, String tool, String description, PluginPermissionDetails details, bool allowAlways
});


$PluginPermissionDetailsCopyWith<$Res> get details;
...
/// Create a copy of PluginPendingPermission
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? sessionID = null,Object? displaySessionId = freezed,Object? tool = null,Object? description = null,Object? details = null,Object? allowAlways = null,}) {
...
as PluginPermissionDetails,allowAlways: null == allowAlways ? _self.allowAlways : allowAlways // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
/// Create a copy of PluginPendingPermission
...
$PluginPermissionDetailsCopyWith<$Res> get details {
  ...
  return $PluginPermissionDetailsCopyWith<$Res>(_self.details, (value) {
...
class _PluginPendingPermission implements PluginPendingPermission {
  const _PluginPendingPermission({required this.id, required this.sessionID, required this.displaySessionId, required this.tool, required this.description, required this.details, required this.allowAlways});
...
@override final  PluginPermissionDetails details;
...
@override
int get hashCode {
    return Object.hash(runtimeType,id,sessionID,displaySessionId,tool,description,details,allowAlways);
}

@override
String toString() {
    return 'PluginPendingPermission(id: $id, sessionID: $sessionID, displaySessionId: $displaySessionId, tool: $tool, description: $description, details: $details, allowAlways: $allowAlways)';
}
...
@override $PluginPermissionDetailsCopyWith<$Res> get details;
...
/// Create a copy of PluginPendingPermission
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? sessionID = null,Object? displaySessionId = freezed,Object? tool = null,Object? description = null,Object? details = null,Object? allowAlways = null,}) {
