...
_AntigravityModelConfigDto _$AntigravityModelConfigDtoFromJson(Map json) =>
...
_AntigravityModelOptionDto _$AntigravityModelOptionDtoFromJson(Map json) =>
    _AntigravityModelOptionDto(
      value: json['value'] as String,
      name: json['name'] as String,
    );

_AntigravityModelGroupDto _$AntigravityModelGroupDtoFromJson(Map json) =>
    _AntigravityModelGroupDto(
