...
void main() {
  group("release manifest data", () {
    test("pins codex 0.142.0", () {
      expect(pinnedCodexVersion, equals("0.142.0"));
    });
    ...
    test("asset filenames match the rust-v0.142.0 release shapes", () {
      ...
      // 0.142.0 ships the Windows binary as an `.exe.zip` (member is the .exe).
