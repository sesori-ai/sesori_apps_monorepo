...
CodexImageGenerationItemDto _$CodexImageGenerationItemDtoFromJson(Map json) => CodexImageGenerationItemDto(
...
CodexMcpToolCallItemDto _$CodexMcpToolCallItemDtoFromJson(Map json) => CodexMcpToolCallItemDto(
  id: json['id'] as String,
...
CodexDynamicToolCallItemDto _$CodexDynamicToolCallItemDtoFromJson(Map json) => CodexDynamicToolCallItemDto(
  id: json['id'] as String,
...
CodexMcpTextContentDto _$CodexMcpTextContentDtoFromJson(Map json) => CodexMcpTextContentDto(
  text: json['text'] as String,
  $type: json['type'] as String?,
);

CodexMcpImageContentDto _$CodexMcpImageContentDtoFromJson(Map json) => CodexMcpImageContentDto(
  data: json['data'] as String,
  mimeType: json['mimeType'] as String,
  $type: json['type'] as String?,
);

CodexDynamicTextContentDto _$CodexDynamicTextContentDtoFromJson(Map json) => CodexDynamicTextContentDto(
  text: json['text'] as String,
  $type: json['type'] as String?,
);

CodexDynamicImageContentDto _$CodexDynamicImageContentDtoFromJson(Map json) => CodexDynamicImageContentDto(
  imageUrl: json['imageUrl'] as String,
  $type: json['type'] as String?,
);

CodexDynamicAudioContentDto _$CodexDynamicAudioContentDtoFromJson(Map json) => CodexDynamicAudioContentDto(
