...
_CodexSkillsListResponseDto _$CodexSkillsListResponseDtoFromJson(Map json) => _CodexSkillsListResponseDto(
...
_CodexSkillsListEntryDto _$CodexSkillsListEntryDtoFromJson(Map json) => _CodexSkillsListEntryDto(
...
_CodexSkillInterfaceDto _$CodexSkillInterfaceDtoFromJson(Map json) => _CodexSkillInterfaceDto(
  shortDescription: json['shortDescription'] as String?,
);
