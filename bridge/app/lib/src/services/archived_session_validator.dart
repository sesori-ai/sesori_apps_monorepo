...
class SessionArchivedReadOnlyException({required final SessionArchivedRejection rejection}) implements Exception {
  @override
...
class ArchivedSessionValidator({required final SessionRepository _sessionRepository}) {
