...
class PluginLifecycleService({
  ...
  /// remains transient, then normal residency restores the configured value.
  ...
  int _suspensionIdleTimeoutMins(PluginRuntimeSnapshot snapshot) {
    ...
    return configured > 0 && snapshot.generationResidency == PluginGenerationResidency.transient
