...
mixin _$SessionDto {
 ...
 String get sessionId; String get backendSessionId; String get projectId; String? get parentSessionId; String get directory; String? get worktreePath; String? get branchName; String? get currentBranchName; String? get currentGithubRepositoryIdentity; bool get isDedicated; int? get archivedAt; String? get baseBranch; String? get baseCommit; String? get lastAgent; AgentModel? get lastAgentModel; int get createdAt; int get updatedAt; int get projectionUpdatedAt; int? get lastActivityAt; int? get lastSeenAt; int? get lastUserMessageAt; String get pluginId; String? get title; String? get catalogTitle;
...
int get hashCode {
  final _this = this as SessionDto;
  return Object.hashAll([runtimeType,_this.sessionId,_this.backendSessionId,_this.projectId,_this.parentSessionId,_this.directory,_this.worktreePath,_this.branchName,_this.currentBranchName,_this.currentGithubRepositoryIdentity,_this.isDedicated,_this.archivedAt,_this.baseBranch,_this.baseCommit,_this.lastAgent,_this.lastAgentModel,_this.createdAt,_this.updatedAt,_this.projectionUpdatedAt,_this.lastActivityAt,_this.lastSeenAt,_this.lastUserMessageAt,_this.pluginId,_this.title,_this.catalogTitle]);
}

@override
String toString() {
  final _this = this as SessionDto;
  return 'SessionDto(sessionId: ${_this.sessionId}, backendSessionId: ${_this.backendSessionId}, projectId: ${_this.projectId}, parentSessionId: ${_this.parentSessionId}, directory: ${_this.directory}, worktreePath: ${_this.worktreePath}, branchName: ${_this.branchName}, currentBranchName: ${_this.currentBranchName}, currentGithubRepositoryIdentity: ${_this.currentGithubRepositoryIdentity}, isDedicated: ${_this.isDedicated}, archivedAt: ${_this.archivedAt}, baseBranch: ${_this.baseBranch}, baseCommit: ${_this.baseCommit}, lastAgent: ${_this.lastAgent}, lastAgentModel: ${_this.lastAgentModel}, createdAt: ${_this.createdAt}, updatedAt: ${_this.updatedAt}, projectionUpdatedAt: ${_this.projectionUpdatedAt}, lastActivityAt: ${_this.lastActivityAt}, lastSeenAt: ${_this.lastSeenAt}, lastUserMessageAt: ${_this.lastUserMessageAt}, pluginId: ${_this.pluginId}, title: ${_this.title}, catalogTitle: ${_this.catalogTitle})';
}
...
@override
int get hashCode {
    return Object.hashAll([runtimeType,sessionId,backendSessionId,projectId,parentSessionId,directory,worktreePath,branchName,currentBranchName,currentGithubRepositoryIdentity,isDedicated,archivedAt,baseBranch,baseCommit,lastAgent,lastAgentModel,createdAt,updatedAt,projectionUpdatedAt,lastActivityAt,lastSeenAt,lastUserMessageAt,pluginId,title,catalogTitle]);
}

@override
String toString() {
    return 'SessionDto(sessionId: $sessionId, backendSessionId: $backendSessionId, projectId: $projectId, parentSessionId: $parentSessionId, directory: $directory, worktreePath: $worktreePath, branchName: $branchName, currentBranchName: $currentBranchName, currentGithubRepositoryIdentity: $currentGithubRepositoryIdentity, isDedicated: $isDedicated, archivedAt: $archivedAt, baseBranch: $baseBranch, baseCommit: $baseCommit, lastAgent: $lastAgent, lastAgentModel: $lastAgentModel, createdAt: $createdAt, updatedAt: $updatedAt, projectionUpdatedAt: $projectionUpdatedAt, lastActivityAt: $lastActivityAt, lastSeenAt: $lastSeenAt, lastUserMessageAt: $lastUserMessageAt, pluginId: $pluginId, title: $title, catalogTitle: $catalogTitle)';
}
