...
mixin _$SessionDto {
 ...
 String get sessionId; String get backendSessionId; String get projectId; String? get parentSessionId; String get directory; String? get worktreePath; String? get branchName; String? get currentBranchName; String? get currentGithubRepositoryIdentity; bool get isDedicated; int? get archivedAt; String? get baseBranch; String? get baseCommit; String? get lastAgent; AgentModel? get lastAgentModel; bool get fastMode; int get createdAt; int get updatedAt; int get projectionUpdatedAt; int? get lastActivityAt; int? get lastSeenAt; int? get lastUserMessageAt; String get pluginId; String? get title; String? get catalogTitle; SessionApprovalMode? get approvalOverride;
...
int get hashCode {
  final _this = this as SessionDto;
  return Object.hashAll([runtimeType,_this.sessionId,_this.backendSessionId,_this.projectId,_this.parentSessionId,_this.directory,_this.worktreePath,_this.branchName,_this.currentBranchName,_this.currentGithubRepositoryIdentity,_this.isDedicated,_this.archivedAt,_this.baseBranch,_this.baseCommit,_this.lastAgent,_this.lastAgentModel,_this.fastMode,_this.createdAt,_this.updatedAt,_this.projectionUpdatedAt,_this.lastActivityAt,_this.lastSeenAt,_this.lastUserMessageAt,_this.pluginId,_this.title,_this.catalogTitle,_this.approvalOverride]);
}

@override
String toString() {
  final _this = this as SessionDto;
  return 'SessionDto(sessionId: ${_this.sessionId}, backendSessionId: ${_this.backendSessionId}, projectId: ${_this.projectId}, parentSessionId: ${_this.parentSessionId}, directory: ${_this.directory}, worktreePath: ${_this.worktreePath}, branchName: ${_this.branchName}, currentBranchName: ${_this.currentBranchName}, currentGithubRepositoryIdentity: ${_this.currentGithubRepositoryIdentity}, isDedicated: ${_this.isDedicated}, archivedAt: ${_this.archivedAt}, baseBranch: ${_this.baseBranch}, baseCommit: ${_this.baseCommit}, lastAgent: ${_this.lastAgent}, lastAgentModel: ${_this.lastAgentModel}, fastMode: ${_this.fastMode}, createdAt: ${_this.createdAt}, updatedAt: ${_this.updatedAt}, projectionUpdatedAt: ${_this.projectionUpdatedAt}, lastActivityAt: ${_this.lastActivityAt}, lastSeenAt: ${_this.lastSeenAt}, lastUserMessageAt: ${_this.lastUserMessageAt}, pluginId: ${_this.pluginId}, title: ${_this.title}, catalogTitle: ${_this.catalogTitle}, approvalOverride: ${_this.approvalOverride})';
}
...
@useResult
$Res call({
 String sessionId, String backendSessionId, String projectId, String? parentSessionId, String directory, String? worktreePath, String? branchName, String? currentBranchName, String? currentGithubRepositoryIdentity, bool isDedicated, int? archivedAt, String? baseBranch, String? baseCommit, String? lastAgent, AgentModel? lastAgentModel, bool fastMode, int createdAt, int updatedAt, int projectionUpdatedAt, int? lastActivityAt, int? lastSeenAt, int? lastUserMessageAt, String pluginId, String? title, String? catalogTitle, SessionApprovalMode? approvalOverride
});
...
/// Create a copy of SessionDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? sessionId = null,Object? backendSessionId = null,Object? projectId = null,Object? parentSessionId = freezed,Object? directory = null,Object? worktreePath = freezed,Object? branchName = freezed,Object? currentBranchName = freezed,Object? currentGithubRepositoryIdentity = freezed,Object? isDedicated = null,Object? archivedAt = freezed,Object? baseBranch = freezed,Object? baseCommit = freezed,Object? lastAgent = freezed,Object? lastAgentModel = freezed,Object? fastMode = null,Object? createdAt = null,Object? updatedAt = null,Object? projectionUpdatedAt = null,Object? lastActivityAt = freezed,Object? lastSeenAt = freezed,Object? lastUserMessageAt = freezed,Object? pluginId = null,Object? title = freezed,Object? catalogTitle = freezed,Object? approvalOverride = freezed,}) {
...
as String?,currentBranchName: freezed == currentBranchName ? _self.currentBranchName : currentBranchName // ignore: cast_nullable_to_non_nullable
as String?,currentGithubRepositoryIdentity: freezed == currentGithubRepositoryIdentity ? _self.currentGithubRepositoryIdentity : currentGithubRepositoryIdentity // ignore: cast_nullable_to_non_nullable
...
class _SessionDto extends SessionDto {
  const _SessionDto({required this.sessionId, required this.backendSessionId, required this.projectId, required this.parentSessionId, required this.directory, required this.worktreePath, required this.branchName, required this.currentBranchName, required this.currentGithubRepositoryIdentity, required this.isDedicated, required this.archivedAt, required this.baseBranch, required this.baseCommit, required this.lastAgent, required this.lastAgentModel, required this.fastMode, required this.createdAt, required this.updatedAt, required this.projectionUpdatedAt, required this.lastActivityAt, required this.lastSeenAt, required this.lastUserMessageAt, required this.pluginId, required this.title, required this.catalogTitle, required this.approvalOverride}): super._();
...
@override final  String? currentBranchName;
@override final  String? currentGithubRepositoryIdentity;
