...
mixin _$SessionDto {
 ...
 String get sessionId; String get backendSessionId; String get projectId; String? get parentSessionId; String get directory; String? get worktreePath; String? get branchName; bool get isDedicated; int? get archivedAt; String? get baseBranch; String? get baseCommit; String? get lastAgent; AgentModel? get lastAgentModel; int get createdAt; int get updatedAt; int get projectionUpdatedAt; int? get lastActivityAt; int? get lastSeenAt; int? get lastUserMessageAt; String get pluginId; String? get title; String? get catalogTitle;
...
@override
int get hashCode => Object.hashAll([runtimeType,sessionId,backendSessionId,projectId,parentSessionId,directory,worktreePath,branchName,isDedicated,archivedAt,baseBranch,baseCommit,lastAgent,lastAgentModel,createdAt,updatedAt,projectionUpdatedAt,lastActivityAt,lastSeenAt,lastUserMessageAt,pluginId,title,catalogTitle]);
