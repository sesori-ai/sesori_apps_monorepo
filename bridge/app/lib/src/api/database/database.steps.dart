...
final class Schema16 extends i0.VersionedSchema {
  ...
  late final Shape21 acceptedPromptsTable = Shape21(
    source: i0.VersionedTable(
      entityName: 'accepted_prompts_table',
      withoutRowId: true,
      isStrict: false,
      tableConstraints: [
      ...
      columns: [_column_4, _column_59, _column_60],
      attachedDatabase: database,
    ),
    alias: null,
  );
...
class Shape21 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get sessionId =>
      columnsByName['session_id']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get promptId =>
      columnsByName['prompt_id']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get acceptedAt =>
      columnsByName['accepted_at']! as i1.GeneratedColumn<int>;
}
...
final class Schema17 extends i0.VersionedSchema {
  ...
  late final Shape22 sessionsTable = Shape22(
    source: i0.VersionedTable(
      entityName: 'sessions_table',
      withoutRowId: true,
      isStrict: false,
  ...
  late final Shape23 newSessionDefaultsTable = Shape23(
    source: i0.VersionedTable(
      entityName: 'new_session_defaults_table',
      withoutRowId: true,
      isStrict: false,
      tableConstraints: ['PRIMARY KEY(plugin_id)', 'CHECK(plugin_id <> \'\')'],
      columns: [_column_30, _column_57, _column_58, _column_61],
      attachedDatabase: database,
    ),
    alias: null,
  );
...
class Shape22 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get lastAgentModel =>
      columnsByName['last_agent_model']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get fastMode =>
      columnsByName['fast_mode']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get createdAt =>
      columnsByName['created_at']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get updatedAt =>
      columnsByName['updated_at']! as i1.GeneratedColumn<int>;
...
final class Schema18 extends i0.VersionedSchema {
  ...
  late final Shape24 sessionContinuations = Shape24(
    source: i0.VersionedTable(
      entityName: 'session_continuations',
      withoutRowId: true,
      isStrict: false,
      tableConstraints: ['PRIMARY KEY(session_id)'],
      columns: [_column_62, _column_63, _column_64],
      attachedDatabase: database,
    ),
    alias: null,
  );
...
class Shape24 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get outcomeJson =>
      columnsByName['outcome_json']! as i1.GeneratedColumn<String>;
}
...
final class Schema19 extends i0.VersionedSchema {
  ...
  late final Shape25 sessionsTable = Shape25(
    source: i0.VersionedTable(
      entityName: 'sessions_table',
      withoutRowId: true,
      isStrict: false,
...
class Shape25 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get catalogTitle =>
      columnsByName['catalog_title']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get approvalOverride =>
      columnsByName['approval_override']! as i1.GeneratedColumn<String>;
}
