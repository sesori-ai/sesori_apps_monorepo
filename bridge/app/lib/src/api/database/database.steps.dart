...
final class Schema16 extends i0.VersionedSchema {
  ...
  late final Shape21 deviceCanvasClaimsTable = Shape21(
    source: i0.VersionedTable(
      entityName: 'device_canvas_claims_table',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: ['PRIMARY KEY(bridge_id, device_key)'],
      columns: [
        _column_59,
        _column_60,
        _column_61,
  ...
  late final Shape22 deviceCanvasClaimRevisionsTable = Shape22(
    source: i0.VersionedTable(
      entityName: 'device_canvas_claim_revisions_table',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: ['PRIMARY KEY(bridge_id)'],
      columns: [_column_59, _column_64],
      attachedDatabase: database,
    ),
    alias: null,
  );
  ...
  final i1.Index idxDeviceCanvasClaimsSession = i1.Index(
...
class Shape21 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get bridgeId =>
      columnsByName['bridge_id']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get deviceKey =>
      columnsByName['device_key']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get sessionId =>
      columnsByName['session_id']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get claimRevision =>
      columnsByName['claim_revision']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get claimedAt =>
      columnsByName['claimed_at']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get updatedAt =>
      columnsByName['updated_at']! as i1.GeneratedColumn<int>;
}
...
class Shape22 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get bridgeId =>
      columnsByName['bridge_id']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get lastRevision =>
      columnsByName['last_revision']! as i1.GeneratedColumn<int>;
}
