...
class RenameProjectHandler(final ProjectRepository _projectRepository)
    extends BodyRequestHandler<RenameProjectRequest, Project> {
  this
    : super(
        HttpMethod.patch,
        "/project/name",
  ...
  Future<Project> handle(
    ...
    return await _projectRepository.renameProject(
