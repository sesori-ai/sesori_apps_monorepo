...
class RequestRouter {
  ...
  RequestRouter({required BridgePlugin plugin, required HiddenProjectsDao hiddenProjectsDao})
    : _handlers = _buildHandlers(plugin: plugin, hiddenProjectsDao: hiddenProjectsDao);

  static List<RequestHandler> _buildHandlers({
    required BridgePlugin plugin,
    required HiddenProjectsDao hiddenProjectsDao,
  }) {
    final hiddenStore = hiddenProjectsDao;
    return [
