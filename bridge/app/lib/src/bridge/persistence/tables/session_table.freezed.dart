...
mixin _$SessionDto {
 ...
 String get sessionId; String get projectId; String? get worktreePath; String? get branchName; bool get isDedicated; int? get archivedAt; String? get baseBranch; String? get baseCommit; String? get lastAgent; AgentModel? get lastAgentModel; int get createdAt; int? get lastActivityAt; int? get lastSeenAt; int? get lastUserMessageAt;
...
@override
int get hashCode => Object.hash(runtimeType,sessionId,projectId,worktreePath,branchName,isDedicated,archivedAt,baseBranch,baseCommit,lastAgent,lastAgentModel,createdAt,lastActivityAt,lastSeenAt,lastUserMessageAt);
...
@useResult
$Res call({
 String sessionId, String projectId, String? worktreePath, String? branchName, bool isDedicated, int? archivedAt, String? baseBranch, String? baseCommit, String? lastAgent, AgentModel? lastAgentModel, int createdAt, int? lastActivityAt, int? lastSeenAt, int? lastUserMessageAt
});
...
class _SessionDto extends SessionDto {
  const _SessionDto({required this.sessionId, required this.projectId, required this.worktreePath, required this.branchName, required this.isDedicated, required this.archivedAt, required this.baseBranch, required this.baseCommit, required this.lastAgent, required this.lastAgentModel, required this.createdAt, required this.lastActivityAt, required this.lastSeenAt, required this.lastUserMessageAt}): super._();
