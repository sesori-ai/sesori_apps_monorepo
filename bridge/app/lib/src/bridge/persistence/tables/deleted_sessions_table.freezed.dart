...
mixin _$DeletedSessionDto {
 ...
 String get sessionId; String get pluginId; int get deletedAt;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DeletedSessionDto&&(identical(other.sessionId, sessionId) || other.sessionId == sessionId)&&(identical(other.pluginId, pluginId) || other.pluginId == pluginId)&&(identical(other.deletedAt, deletedAt) || other.deletedAt == deletedAt));
}


@override
int get hashCode => Object.hash(runtimeType,sessionId,pluginId,deletedAt);

@override
String toString() {
  return 'DeletedSessionDto(sessionId: $sessionId, pluginId: $pluginId, deletedAt: $deletedAt)';
}
...
@useResult
$Res call({
 String sessionId, String pluginId, int deletedAt
});
...
/// Create a copy of DeletedSessionDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? sessionId = null,Object? pluginId = null,Object? deletedAt = null,}) {
...
class _DeletedSessionDto extends DeletedSessionDto {
  const _DeletedSessionDto({required this.sessionId, required this.pluginId, required this.deletedAt}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DeletedSessionDto&&(identical(other.sessionId, sessionId) || other.sessionId == sessionId)&&(identical(other.pluginId, pluginId) || other.pluginId == pluginId)&&(identical(other.deletedAt, deletedAt) || other.deletedAt == deletedAt));
}
...
/// Create a copy of DeletedSessionDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? sessionId = null,Object? pluginId = null,Object? deletedAt = null,}) {
