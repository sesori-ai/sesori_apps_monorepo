...
mixin _$ProjectDto {
 ...
 String get projectId; String get path; bool get hidden; String? get baseBranch; int get worktreeCounter; String? get displayName; int get createdAt; int get updatedAt; int get projectionUpdatedAt;
...
@override
int get hashCode => Object.hash(runtimeType,projectId,path,hidden,baseBranch,worktreeCounter,displayName,createdAt,updatedAt,projectionUpdatedAt);

@override
String toString() {
  return 'ProjectDto(projectId: $projectId, path: $path, hidden: $hidden, baseBranch: $baseBranch, worktreeCounter: $worktreeCounter, displayName: $displayName, createdAt: $createdAt, updatedAt: $updatedAt, projectionUpdatedAt: $projectionUpdatedAt)';
}
...
@useResult
$Res call({
 String projectId, String path, bool hidden, String? baseBranch, int worktreeCounter, String? displayName, int createdAt, int updatedAt, int projectionUpdatedAt
});
...
/// Create a copy of ProjectDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? projectId = null,Object? path = null,Object? hidden = null,Object? baseBranch = freezed,Object? worktreeCounter = null,Object? displayName = freezed,Object? createdAt = null,Object? updatedAt = null,Object? projectionUpdatedAt = null,}) {
...
class _ProjectDto extends ProjectDto {
  const _ProjectDto({required this.projectId, required this.path, this.hidden = false, this.baseBranch, this.worktreeCounter = 0, this.displayName, required this.createdAt, required this.updatedAt, required this.projectionUpdatedAt}): super._();
...
/// Create a copy of ProjectDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? projectId = null,Object? path = null,Object? hidden = null,Object? baseBranch = freezed,Object? worktreeCounter = null,Object? displayName = freezed,Object? createdAt = null,Object? updatedAt = null,Object? projectionUpdatedAt = null,}) {
