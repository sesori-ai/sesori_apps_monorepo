...
typedef ProjectActivityObservation = ({
  String pluginId,
  int generation,
  List<ProjectActivityEvidence> evidence,
});
...
class ProjectActivityRepository {
  ...
  Future<ProjectActivityObservation?> listProjectActivityEvidence({required String pluginId}) async {
    final source = await _runtime.useIfActive<_ProjectActivitySource>(
      pluginId: pluginId,
    ...
    switch (source) {
      case _NativeProjectActivitySource():
        evidence = await _persistNativeProjectActivityEvidence(source: source);
      case _ResolvedProjectActivitySource(evidence: final resolvedEvidence):
  ...
  Future<void> commitActivities({
    required ProjectActivityObservation observation,
    ...
    return _runtime.commitCurrentGeneration(
      ...
      operation: _ProjectActivityOperation.commitActivities,
      commit: () => _projectsDao.setAllActivities(activities: activities),
    );
  }
  ...
  Future<List<ProjectActivityEvidence>> _persistNativeProjectActivityEvidence({
    ...
    return _runtime.commitCurrentGeneration(
      ...
      generation: source.generation,
      operation: _ProjectActivityOperation.listProjectActivityEvidence,
      commit: () => _projectsDao.transaction(() async {
