...
int get hashCode {
  final _this = this as DeviceCanvasRendezvous;
  return Object.hash(runtimeType,_this.protocolVersion,_this.port,_this.bearerSecret,_this.bridgeId,_this.processGeneration);
}

@override
String toString() {
  final _this = this as DeviceCanvasRendezvous;
  return 'DeviceCanvasRendezvous(protocolVersion: ${_this.protocolVersion}, port: ${_this.port}, bearerSecret: ${_this.bearerSecret}, bridgeId: ${_this.bridgeId}, processGeneration: ${_this.processGeneration})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,protocolVersion,port,bearerSecret,bridgeId,processGeneration);
}
