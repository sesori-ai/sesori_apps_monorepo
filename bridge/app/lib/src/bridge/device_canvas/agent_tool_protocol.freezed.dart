...
bool operator ==(Object other) {
  final _this = this as DeviceCanvasAgentToolRendezvous;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DeviceCanvasAgentToolRendezvous&&(identical(other.protocolVersion, _this.protocolVersion) || other.protocolVersion == _this.protocolVersion)&&(identical(other.port, _this.port) || other.port == _this.port));
}
...
int get hashCode {
  final _this = this as DeviceCanvasAgentToolRendezvous;
  return Object.hash(runtimeType,_this.protocolVersion,_this.port);
}

@override
String toString() {
  final _this = this as DeviceCanvasAgentToolRendezvous;
  return 'DeviceCanvasAgentToolRendezvous(protocolVersion: ${_this.protocolVersion}, port: ${_this.port})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,protocolVersion,port);
}
...
@override
bool operator ==(Object other) {
  final _this = this as DeviceCanvasAgentToolRegistrationResponse;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DeviceCanvasAgentToolRegistrationResponse&&(identical(other.bearerToken, _this.bearerToken) || other.bearerToken == _this.bearerToken));
}
...
int get hashCode {
  final _this = this as DeviceCanvasAgentToolRegistrationResponse;
  return Object.hash(runtimeType,_this.bearerToken);
}

@override
String toString() {
  final _this = this as DeviceCanvasAgentToolRegistrationResponse;
  return 'DeviceCanvasAgentToolRegistrationResponse(bearerToken: ${_this.bearerToken})';
}
...
@override
bool operator ==(Object other) {
  final _this = this as DeviceCanvasAgentToolListRequest;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DeviceCanvasAgentToolListRequest&&(identical(other.backendSessionId, _this.backendSessionId) || other.backendSessionId == _this.backendSessionId));
}
...
int get hashCode {
  final _this = this as DeviceCanvasAgentToolListRequest;
  return Object.hash(runtimeType,_this.backendSessionId);
}

@override
String toString() {
  final _this = this as DeviceCanvasAgentToolListRequest;
  return 'DeviceCanvasAgentToolListRequest(backendSessionId: ${_this.backendSessionId})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,backendSessionId);
}
...
@override
bool operator ==(Object other) {
  final _this = this as DeviceCanvasAgentToolMutationRequest;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DeviceCanvasAgentToolMutationRequest&&(identical(other.backendSessionId, _this.backendSessionId) || other.backendSessionId == _this.backendSessionId)&&(identical(other.deviceKey, _this.deviceKey) || other.deviceKey == _this.deviceKey));
}
...
int get hashCode {
  final _this = this as DeviceCanvasAgentToolMutationRequest;
  return Object.hash(runtimeType,_this.backendSessionId,_this.deviceKey);
}

@override
String toString() {
  final _this = this as DeviceCanvasAgentToolMutationRequest;
  return 'DeviceCanvasAgentToolMutationRequest(backendSessionId: ${_this.backendSessionId}, deviceKey: ${_this.deviceKey})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,backendSessionId,deviceKey);
}
...
int get hashCode {
  final _this = this as DeviceCanvasAgentToolDevice;
  return Object.hash(runtimeType,_this.deviceKey,_this.platform,_this.displayName,_this.runtimeDescription,_this.modelDescription,_this.ownership);
}

@override
String toString() {
  final _this = this as DeviceCanvasAgentToolDevice;
  return 'DeviceCanvasAgentToolDevice(deviceKey: ${_this.deviceKey}, platform: ${_this.platform}, displayName: ${_this.displayName}, runtimeDescription: ${_this.runtimeDescription}, modelDescription: ${_this.modelDescription}, ownership: ${_this.ownership})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,deviceKey,platform,displayName,runtimeDescription,modelDescription,ownership);
}
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is DeviceCanvasAgentToolListedResponse&&const DeepCollectionEquality().equals(other.devices, _devices)&&(identical(other.truncated, truncated) || other.truncated == truncated));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode {
    return Object.hash(runtimeType,const DeepCollectionEquality().hash(_devices),truncated);
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,deviceKey);
}
