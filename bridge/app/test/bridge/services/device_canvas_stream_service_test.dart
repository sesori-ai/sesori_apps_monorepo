...
class _StreamFixture({
  ...
  static Future<_StreamFixture> create({Duration leaseDuration = const Duration(minutes: 10)}) async {
  ...
  DeviceCanvasStreamStatusRequest statusRequest() => DeviceCanvasStreamStatusRequest(
    expectedBridgeId: _bridgeId,
    sessionId: _sessionId,
    deviceKey: _deviceKey,
  ...
  DeviceCanvasStreamStopRequest stopRequest({required String leaseId}) => DeviceCanvasStreamStopRequest(
    expectedBridgeId: _bridgeId,
    sessionId: _sessionId,
    deviceKey: _deviceKey,
    expectedClaimRevision: claimRevision,
