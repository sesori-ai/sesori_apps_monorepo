...
mixin SessionsTableToColumns implements Insertable<SessionsTableData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['fast_mode'] = Variable<int>(fastMode);
    map['created_at'] = Variable<int>(createdAt);
    map['updated_at'] = Variable<int>(updatedAt);
    map['projection_updated_at'] = Variable<int>(projectionUpdatedAt);
    ...
    if (!nullToAbsent || approvalOverride != null) {
      map['approval_override'] = Variable<String>(approvalOverride);
    }
    return map;
  }
}
...
class SessionsTable extends Table
  ...
  late final GeneratedColumn<int> fastMode = GeneratedColumn<int>(
    'fast_mode',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 0 CHECK (fast_mode IN (0, 1))',
    defaultValue: const CustomExpression('0'),
  );
  late final GeneratedColumn<int> createdAt = GeneratedColumn<int>(
    'created_at',
  ...
  late final GeneratedColumn<String> approvalOverride = GeneratedColumn<String>(
    'approval_override',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  SessionsTableData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return SessionsTableData(
      ...
      approvalOverride: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
...
class SessionsTableData extends DataClass with SessionsTableToColumns {
  ...
  SessionsTableCompanion toCompanion(bool nullToAbsent) {
    return SessionsTableCompanion(
      ...
      catalogTitle: catalogTitle == null && nullToAbsent
          ? const Value.absent()
          : Value(catalogTitle),
      approvalOverride: approvalOverride == null && nullToAbsent
          ? const Value.absent()
  ...
  factory SessionsTableData.fromJson(
    ...
    return SessionsTableData(
      ...
      fastMode: serializer.fromJson<int>(json['fastMode']),
      createdAt: serializer.fromJson<int>(json['createdAt']),
      updatedAt: serializer.fromJson<int>(json['updatedAt']),
      projectionUpdatedAt: serializer.fromJson<int>(
        json['projectionUpdatedAt'],
      ...
      approvalOverride: serializer.fromJson<String?>(json['approvalOverride']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'fastMode': serializer.toJson<int>(fastMode),
      'createdAt': serializer.toJson<int>(createdAt),
      'updatedAt': serializer.toJson<int>(updatedAt),
      'projectionUpdatedAt': serializer.toJson<int>(projectionUpdatedAt),
      ...
      'approvalOverride': serializer.toJson<String?>(approvalOverride),
    };
  }
  ...
  SessionsTableData copyWith({
    ...
    Value<String?> approvalOverride = const Value.absent(),
  }) => SessionsTableData(
    ...
    approvalOverride: approvalOverride.present
  ...
  SessionsTableData copyWithCompanion(SessionsTableCompanion data) {
    return SessionsTableData(
      ...
      catalogTitle: data.catalogTitle.present
          ...
          : this.catalogTitle,
      approvalOverride: data.approvalOverride.present
          ? data.approvalOverride.value
          : this.approvalOverride,
    );
  }
  ...
  bool operator ==(Object other) =>
      ...
      (other is SessionsTableData &&
          ...
          other.approvalOverride == this.approvalOverride);
}
...
class SessionsTableCompanion extends UpdateCompanion<SessionsTableData> {
  ...
  final Value<String?> approvalOverride;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (fastMode.present) {
      map['fast_mode'] = Variable<int>(fastMode.value);
    }
    if (createdAt.present) {
      map['created_at'] = Variable<int>(createdAt.value);
    }
    ...
    if (approvalOverride.present) {
      map['approval_override'] = Variable<String>(approvalOverride.value);
    }
    return map;
  }
...
mixin AcceptedPromptsTableToColumns
...
class AcceptedPromptsTable extends Table
    with TableInfo<AcceptedPromptsTable, AcceptedPromptsTableData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  AcceptedPromptsTable(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> sessionId = GeneratedColumn<String>(
    'session_id',
    aliasedName,
    false,
  ...
  @override
  AcceptedPromptsTable createAlias(String alias) {
    return AcceptedPromptsTable(attachedDatabase, alias);
  }
...
class AcceptedPromptsTableData extends DataClass
    with AcceptedPromptsTableToColumns {
  @override
  final String sessionId;
  @override
...
mixin SessionContinuationsToColumns
    implements Insertable<SessionContinuationsData> {
  String get sessionId;
  int get enabled;
...
class SessionContinuations extends Table
    with TableInfo<SessionContinuations, SessionContinuationsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  SessionContinuations(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> sessionId = GeneratedColumn<String>(
    'session_id',
    aliasedName,
    false,
  ...
  Set<GeneratedColumn> get $primaryKey => {sessionId};
  @override
  SessionContinuationsData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return SessionContinuationsData(
      sessionId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}session_id'],
      )!,
  ...
  @override
  SessionContinuations createAlias(String alias) {
    return SessionContinuations(attachedDatabase, alias);
  }
...
class SessionContinuationsData extends DataClass
    with SessionContinuationsToColumns {
  @override
  final String sessionId;
  @override
  final int enabled;
  ...
  const SessionContinuationsData({
    required this.sessionId,
    required this.enabled,
    required this.outcomeJson,
  });
  SessionContinuationsCompanion toCompanion(bool nullToAbsent) {
    return SessionContinuationsCompanion(
      sessionId: Value(sessionId),
  ...
  factory SessionContinuationsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  SessionContinuationsData copyWith({
    String? sessionId,
    int? enabled,
    String? outcomeJson,
  }) => SessionContinuationsData(
    sessionId: sessionId ?? this.sessionId,
    enabled: enabled ?? this.enabled,
    outcomeJson: outcomeJson ?? this.outcomeJson,
  );
  SessionContinuationsData copyWithCompanion(
    SessionContinuationsCompanion data,
  ) {
    return SessionContinuationsData(
      sessionId: data.sessionId.present ? data.sessionId.value : this.sessionId,
  ...
  @override
  String toString() {
    return (StringBuffer('SessionContinuationsData(')
          ..write('sessionId: $sessionId, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is SessionContinuationsData &&
          other.sessionId == this.sessionId &&
          other.enabled == this.enabled &&
          other.outcomeJson == this.outcomeJson);
}

class SessionContinuationsCompanion
    extends UpdateCompanion<SessionContinuationsData> {
  final Value<String> sessionId;
  final Value<int> enabled;
  final Value<String> outcomeJson;
  const SessionContinuationsCompanion({
    this.sessionId = const Value.absent(),
    this.enabled = const Value.absent(),
    this.outcomeJson = const Value.absent(),
  });
  SessionContinuationsCompanion.insert({
    required String sessionId,
    ...
    required String outcomeJson,
       ...
       enabled = Value(enabled),
       outcomeJson = Value(outcomeJson);
  static Insertable<SessionContinuationsData> custom({
    Expression<String>? sessionId,
  ...
  SessionContinuationsCompanion copyWith({
    Value<String>? sessionId,
    Value<int>? enabled,
  ...
  @override
  String toString() {
    return (StringBuffer('SessionContinuationsCompanion(')
          ..write('sessionId: $sessionId, ')
          ..write('enabled: $enabled, ')
          ..write('outcomeJson: $outcomeJson')
          ..write(')'))
...
class DatabaseAtV19 extends GeneratedDatabase {
  ...
  late final AcceptedPromptsTable acceptedPromptsTable = AcceptedPromptsTable(
    this,
  );
  late final SessionContinuations sessionContinuations = SessionContinuations(
    this,
  );
