...
mixin AcceptedCommandInvocationsTableToColumns
    implements Insertable<AcceptedCommandInvocationsTableData> {
...
class AcceptedCommandInvocationsTable extends Table
    with
        TableInfo<
          ...
          AcceptedCommandInvocationsTableData
        > {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  AcceptedCommandInvocationsTable(this.attachedDatabase, [this._alias]);
  ...
  @override
  AcceptedCommandInvocationsTableData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return AcceptedCommandInvocationsTableData(
  ...
  @override
  AcceptedCommandInvocationsTable createAlias(String alias) {
    return AcceptedCommandInvocationsTable(attachedDatabase, alias);
  }

  @override
  bool get withoutRowId => true;
  @override
  List<String> get customConstraints => const ['PRIMARY KEY(invocation_id)'];
  @override
  bool get dontWriteConstraints => true;
}

class AcceptedCommandInvocationsTableData extends DataClass
    with AcceptedCommandInvocationsTableToColumns {
  @override
  ...
  const AcceptedCommandInvocationsTableData({
  ...
  AcceptedCommandInvocationsTableCompanion toCompanion(bool nullToAbsent) {
    return AcceptedCommandInvocationsTableCompanion(
      ...
      backendMessageId: backendMessageId == null && nullToAbsent
          ? const Value.absent()
          : Value(backendMessageId),
    );
  }

  factory AcceptedCommandInvocationsTableData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  AcceptedCommandInvocationsTableData copyWith({
    String? invocationId,
    String? sessionId,
    String? pluginId,
    String? name,
    ...
    backendMessageId: backendMessageId.present
        ? backendMessageId.value
        : this.backendMessageId,
  );
  AcceptedCommandInvocationsTableData copyWithCompanion(
    ...
    return AcceptedCommandInvocationsTableData(
      ...
      acceptedAt: data.acceptedAt.present
          ...
          : this.acceptedAt,
      backendMessageId: data.backendMessageId.present
          ? data.backendMessageId.value
          : this.backendMessageId,
    );
  }
  ...
  @override
  String toString() {
    return (StringBuffer('AcceptedCommandInvocationsTableData(')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is AcceptedCommandInvocationsTableData &&
...
class AcceptedCommandInvocationsTableCompanion
    extends UpdateCompanion<AcceptedCommandInvocationsTableData> {
  ...
  AcceptedCommandInvocationsTableCompanion.insert({
    ...
    this.backendMessageId = const Value.absent(),
       ...
       name = Value(name),
       acceptedAt = Value(acceptedAt);
  static Insertable<AcceptedCommandInvocationsTableData> custom({
...
class DatabaseAtV12 extends GeneratedDatabase {
  ...
  late final AcceptedCommandInvocationsTable acceptedCommandInvocationsTable =
      AcceptedCommandInvocationsTable(this);
