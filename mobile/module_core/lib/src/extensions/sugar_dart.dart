...
// Future<Either<ERR, T>> tryCatchDartz<T, ERR>(
//   FutureOr<T> Function() invoker,
//   FutureOr<ERR> Function(Object error) errorMapper,
// ) =>
//     tryCatchAsync(
//       t: () async => right(await invoker()),
//       c: (e) async => left(await errorMapper(e)),
//     );
