/// Typed reasons for a failed session-detail load, used by
/// [SessionDetailState.failed] so the UI can perform an exhaustive switch
...
enum SessionDetailFailedReason {
