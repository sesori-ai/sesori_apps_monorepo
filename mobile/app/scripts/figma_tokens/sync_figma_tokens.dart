...
final _primitivesPath = "$_projectRoot/lib/design_language/zyra/theme/primitives/zyra_color_primitives.g.dart";
final _colorsPath = "$_projectRoot/lib/design_language/zyra/theme/primitives/zyra_colors.g.dart";
final _spacingPrimitivesPath = "$_projectRoot/lib/design_language/zyra/theme/primitives/zyra_spacing_primitives.g.dart";
final _spacingPath = "$_projectRoot/lib/design_language/zyra/theme/primitives/zyra_spacing.g.dart";
final _radiusPath = "$_projectRoot/lib/design_language/zyra/theme/primitives/zyra_radius.g.dart";
final _widthsPath = "$_projectRoot/lib/design_language/zyra/theme/primitives/zyra_widths.g.dart";
