...
import "../prego_rolling_text.dart";

/// Displays a formatted monetary balance with distinct styling for the
/// integer and fractional parts, matching the Figma `pregoTotalBalance` component.
///
...
///
/// The integer and fractional parts animate using [PregoRollingText] based on
