...
class _PregoRollingTextState extends State<PregoRollingText> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(PregoRollingText oldWidget) {
  ...
  bool _resolveRollUp({required String? oldChar, required String? newChar}) {
    switch (widget.direction) {
      case PregoRollingTextDirection.up:
        return true;
      case PregoRollingTextDirection.down:
        return false;
      case PregoRollingTextDirection.perCharacter:
