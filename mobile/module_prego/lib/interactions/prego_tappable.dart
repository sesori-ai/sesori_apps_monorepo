...
/// Mutually exclusive builder modes for [PregoTappable].
///
...
///
/// Use [PregoTappable.stateAware] when the component needs to control its own
/// interaction styling (e.g. background colour changes on hover, underline, etc.)
/// instead of relying on the default overlay.
class PregoTappable extends StatelessWidget {
          ...
          return Transform.scale(
            ...
            child: DecoratedBox(
              decoration: _shapeDecoration(
                ...
                useSuperellipse: widget.useSuperellipse,
                shadows: isDark ? null : _scaledShadows(prego.shadows.md, scaleProgress),
              ),
              child: Stack(
                fit: StackFit.passthrough,
                clipBehavior: Clip.none,
...
/// [PregoTappable.overlayInset] is set.
///
