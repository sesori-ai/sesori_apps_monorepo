...
2.1. The Service is designed to let you connect compatible AI coding assistants running on your own host system with your mobile device so that you can browse projects, review sessions, receive real-time updates, respond to prompts, and use related official Sesori features.

2.2. The Service may include, without limitation, local bridge software running on your host system, relay transport, account and authentication features, push notification delivery, mobile clients, websites, diagnostics, support tools, analytics, and related hosted components.
...
3.1. You may use the Service only if you have the legal capacity and authority to enter into this agreement.

3.2. If you use the Service on behalf of an organization or another person, you represent and warrant that you are authorized to bind that party to these Terms and Conditions.

3.3. You represent and warrant that your access to and use of the Service will comply with applicable law, regulation, sanctions, export controls, and governmental restrictions.
...
4.6. You acknowledge that ordinary operation of the Service does not ordinarily require Sesori to ingest, store, or manually review full workspace or full session content as stored on your host system. In ordinary operation, Sesori infrastructure may route encrypted relay traffic between your devices and does not ordinarily have plaintext access to relay payloads in transit, while limited data may be processed in connection with notifications, account and authentication data, analytics, diagnostics, support flows, and limited feature processing. Even so, no networked system is risk free, and some data exposure, loss, corruption, delay, or misdelivery may still occur.
...
6.3. You grant Sesori and its service providers acting on Sesori's behalf a worldwide, non-exclusive, royalty-free license to host, store, cache, reproduce, transmit, communicate, display, adapt, reformat, analyze, process, and otherwise use User Content as reasonably necessary to operate, provide, secure, maintain, debug, support, enforce, improve, and make available the Service and its features.

6.4. The license above includes the right to process User Content through automated systems and manual workflows where reasonably necessary for support, abuse prevention, security monitoring and investigation, incident response, legal compliance, troubleshooting, quality improvement, feature operation, and service administration.

6.5. Sesori will not use your User Content to train general-purpose machine learning or general-purpose AI models.
...
7.1. The Service is designed so that ordinary operation does not ordinarily require Sesori to ingest, store, or manually review full workspace or full session content as stored on your host system. In ordinary operation, official Sesori infrastructure may route encrypted relay traffic between your devices and does not ordinarily have plaintext access to relay payloads in transit, while limited notifications, metadata, diagnostics, support flows, analytics, and other service operations you invoke may involve additional processing of limited data.

7.2. Sesori may process account details, authentication data, connection metadata, device and app metadata, analytics, diagnostic information, support information, notification payloads, limited session metadata, limited feature processing inputs and outputs, and other data reasonably necessary to provide, secure, support, maintain, enforce, and improve the Service.
...
7.5. Third-party providers such as hosting, analytics, crash reporting, authentication, messaging, notification, infrastructure, customer support, app distribution, providers supporting limited feature processing you invoke, and security vendors may store, receive, or access limited data while providing their services to us.

7.6. Although we take steps intended to protect the Service, we do not promise perfect privacy, perfect confidentiality, perfect end-to-end secrecy, or absolute security.
...
1. deploy, transmit, coordinate, facilitate, or promote malware, ransomware, spyware, destructive code, botnets, or other malicious software;
2. gain or attempt to gain unauthorized access to any account, device, host system, project, repository, network, or data;
3. steal credentials, secrets, passwords, session secrets, or other authentication material, or assist others in doing so;
4. commit or facilitate fraud, deception, phishing, impersonation, or social engineering;
5. harass, threaten, abuse, stalk, exploit, extort, or otherwise harm another person or organization;
6. conduct illegal surveillance, unlawful interception, or unauthorized monitoring of communications, devices, or activity;
7. bypass, disable, defeat, or interfere with security, safety, usage, or access controls;
8. interfere with, overload, disrupt, degrade, or damage the Service or any connected system;
9. upload, transmit, or process unlawful content or use the Service in connection with unlawful activity;
10. use the Service in a way that is harmful, abusive, reckless, or otherwise likely to create legal, operational, or security risk for others;
11. misrepresent your identity, affiliation, or authorization;
12. violate export controls, sanctions, embargoes, or other trade restrictions; or
13. encourage, direct, assist, or enable any other person to do any of the foregoing.
...
9.1. The Service may interoperate with AI assistants, local tools, operating systems, cloud providers, notification systems, app stores, source repositories, identity providers, and other third-party products or services.

9.2. Sesori does not control, endorse, or assume responsibility for third-party products or services, including any connected AI tool or any output, action, failure, policy, or security issue arising from them.

9.3. Your use of third-party services is at your own risk and may be subject to separate terms, privacy notices, and fees from those third parties.
...
11.2. Sesori may update these Terms and Conditions from time to time. We will post the updated version at `sesori.com` or otherwise make it available through the Service. Unless we state otherwise, changes become effective when posted.

11.3. Your continued use of the Service after updated terms become effective means you accept the updated terms. If you do not agree, you must stop using the Service.
...
15.4. Some jurisdictions do not allow certain disclaimers or limitations of liability, so parts of this Section 15 may not apply to you to the extent prohibited by law.

15.5. If you are dissatisfied with the Service, your sole and exclusive remedy is to stop using it.

## 16. Indemnification

To the maximum extent permitted by law, you will defend, indemnify, and hold harmless Sesori and its shareholders, directors, officers, employees, contractors, affiliates, licensors, and service providers from and against any claims, actions, liabilities, damages, judgments, awards, losses, costs, expenses, and reasonable legal fees arising out of or relating to your use of the Service, your User Content, your violation of these Terms and Conditions, your violation of law, or your violation of any right of any person or entity.
...
18.1. Entire agreement. These Terms and Conditions constitute the entire agreement between you and Sesori regarding the official Service covered here and supersede prior or contemporaneous understandings on that subject.

18.2. Severability. If any provision of these Terms and Conditions is held invalid, illegal, or unenforceable, the remaining provisions will remain in full force and effect, and the invalid provision will be enforced to the maximum extent permitted by law.

18.3. No waiver. Failure to enforce any provision is not a waiver of that provision or any other provision.

18.4. Assignment. You may not assign or transfer these Terms and Conditions without our prior written consent. We may assign these Terms and Conditions, in whole or in part, in connection with an affiliate transaction, restructuring, merger, acquisition, sale of assets, or by operation of law.

18.5. Language. Any translation is provided for convenience only. The English version controls if there is any inconsistency.

## 19. Contact

If you have questions about these Terms and Conditions, contact us at [contact@sesori.com](mailto:contact@sesori.com).
