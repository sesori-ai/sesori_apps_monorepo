...
| 4/6 | `🚧 [claude-inline-subtasks] cursor: safe Task stop policy [step 4/6]` | Implemented and checked locally, unpublished: exact count, process residency, typed refusal, safe root cancel/re-check, bridge/client/UI flow, tests, and docs; no replay/native QA |
