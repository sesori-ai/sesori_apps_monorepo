...
| 3.A/5 | apps monorepo | `[user-analytics] Add client analytics contracts and delivery [step 3.A/5]` | PR #611 merged as `3a181ee3` | Step 2 deployed |
| 3.B/5 | apps monorepo | `[user-analytics] Add durable analytics preference sync [step 3.B/5]` | PR #612 open from verified commit `00f55023`; CI running | Step 3.A |
| 3.C/5 | apps monorepo | `[user-analytics] Add account-linked analytics lifecycle [step 3.C/5]` | PR #613 open from verified stack merge `1bc7460c`; CI pending | Step 3.B |
| 3.D/5 | apps monorepo | `[user-analytics] Integrate analytics settings and routing [step 3.D/5]` | PR #614 open from verified implementation merge `c99a8cf8`; CI pending | Step 3.C |
