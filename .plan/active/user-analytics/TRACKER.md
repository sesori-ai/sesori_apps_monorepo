...
| 3.C/5 | apps monorepo | `[user-analytics] Add account-linked analytics lifecycle [step 3.C/5]` | PR #613 open at `b65cb974`; supplemental lifecycle decomposition PR #619 merged into its branch | Step 3.B |
| 3.D/5 | apps monorepo | `[user-analytics] Integrate analytics settings and routing [step 3.D/5]` | PR #614 open and approved; updated Step 3.C branch propagated with local core/app/desktop verification passing | Step 3.C |
