...
| 3.A/5 | apps monorepo | `[user-analytics] Add client analytics contracts and delivery [step 3.A/5]` | Local replacement commit `11915231` verified; PR pending | Step 2 deployed |
| 3.B/5 | apps monorepo | `[user-analytics] Add durable analytics preference sync [step 3.B/5]` | Local replacement commit `762d6b42` verified; PR pending | Step 3.A |
| 3.C/5 | apps monorepo | `[user-analytics] Add account-linked analytics lifecycle [step 3.C/5]` | Local replacement commit `06c0ca53` verified; PR pending | Step 3.B |
| 3.D/5 | apps monorepo | `[user-analytics] Integrate analytics settings and routing [step 3.D/5]` | Replacement branch implementation and verification in progress | Step 3.C |
