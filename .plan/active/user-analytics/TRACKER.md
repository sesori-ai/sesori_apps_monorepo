...
| 3.C/5 | apps monorepo | `[user-analytics] Add account-linked analytics lifecycle [step 3.C/5]` | PR #613 open at `6b80b7bf`; supplemental lifecycle decomposition PR #619 targets its branch at `86b4e049` | Step 3.B |
