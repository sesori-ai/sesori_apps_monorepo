...
- `dart pub get`, `dart run build_runner build`, `dart test` (133 tests),
  `dart analyze --fatal-infos`, and `git diff --check`: pass.
...
- Diff from merge base after review feedback: +7,169/-22 = 7,191 changed
  lines; generated lines: 4,262; tests run: 133.
