...
- Step 7.c: the preserved modal branch is integrating merged #1502 before
  reopening #1501. Its historical 87 revision-scoped cases, analyzers, nine
  inspected fixtures and architecture review remain scoped to their recorded
  revisions, not the combined head. See [step 7.c evidence](steps/step-07c.md).
