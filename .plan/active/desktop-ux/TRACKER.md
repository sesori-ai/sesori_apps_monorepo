...
| [x] | 9.a.2 | `desktop-ux/app-logs` | `⚙️ [desktop-ux] Write app logs to rotating files [step 13/18]` | ≤ 1,300 | done |
| [ ] | 9.b | `desktop-ux/sidebar-interactions` | `🌿 [desktop-ux] Fix sidebar resizing and project hit targets [step 14/18]` | ≤ 500 | in-progress |
...
Next: 9.b → 9.c → 10 → 11 → 12. The sidebar additions implement the
user's drag/hit-target, priority activity, footer/wording, refresh, animation and
tooltip feedback. One PR at a time; one local successor may be prepared.
