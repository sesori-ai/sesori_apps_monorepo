...
| [ ] | 9.c.2b.2 | `desktop-ux/project-refresh-ownership` | [18/22](#pr-titles) | ≤ 1,400 | in-progress |
...
Current: finish 9.c.2b.2 project ownership → 9.c.2c typed refresh workflow/prepared controls → 10 → 11 → 12.
