...
| [ ] | 6/11 | `codex-stability-deep-test-6-restart-tool-terminalization` | `⚙️ [codex-plugin-stability-feedback] fix(codex): settle interrupted tools after restart [step 6/11]` | 119 actual | [PR #743](https://github.com/sesori-ai/sesori_apps_monorepo/pull/743) open; verified after D5 and current `main` merged forward |
...
- **Step 6 change size:** 119 lines against the PR merge base, including
