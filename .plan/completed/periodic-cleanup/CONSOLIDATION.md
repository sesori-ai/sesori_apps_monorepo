...
| 2 Runtime composition/cold start | Steps 12–13 | Keep install extraction; add provision graph composition and bounded cold-start wait. Preserve plugin validators, OMP dynamic Linux resolver, descriptor HTTP lifetime and unconditional abort rollback. No single-use installer guard. |
