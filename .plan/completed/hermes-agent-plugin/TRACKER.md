...
- **Series state:** All 9 steps implemented and verified (unit tests, full bridge suite, live E2E against real `hermes acp`). PRs #895–#902 opened; this plan PR retires the series.
- **Current step:** 9/9, retire the plan
- **Plan PR:** https://github.com/sesori-ai/sesori_apps_monorepo/pull/895
- **Implementation PRs:** #896 (scaffold), #897 (core), #898 (descriptor), #899 (registration), #900 (client branding), #901 (regression docs), #902 (live verify)
- **Next action:** review and merge the series in order; diffs shrink automatically as earlier PRs land.
