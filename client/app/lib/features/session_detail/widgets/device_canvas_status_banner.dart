    ...
    return BlocBuilder<SessionDetailCubit, SessionDetailState>(
      buildWhen: (previous, current) => switch ((previous, current)) {
        ...
        (
          ...
          SessionDetailLoading() || SessionDetailLoaded() || SessionDetailHarnessUnavailable() || SessionDetailFailed(),
        ) ||
        (
          SessionDetailLoaded(),
          SessionDetailLoading() || SessionDetailHarnessUnavailable() || SessionDetailFailed(),
      ...
      builder: (context, state) {
        final deviceCanvas = switch (state) {
          ...
          SessionDetailFailed() => const DeviceCanvasSessionHidden(),
        };
