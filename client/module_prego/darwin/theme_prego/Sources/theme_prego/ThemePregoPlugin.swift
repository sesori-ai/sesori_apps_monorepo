...
public final class ThemePregoPlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    ...
    registrar.register(
      NativeAiLoaderPlatformViewFactory(messenger: messenger),
      withId: NativeAiLoaderPlatformViewFactory.viewType
    )
    FlutterMethodChannel(name: "theme_prego/date_patterns", binaryMessenger: messenger)
      .setMethodCallHandler { _, result in result(systemDatePatterns()) }
  }
}
