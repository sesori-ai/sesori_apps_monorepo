...
/// Shared mobile notification-preference view.
///
/// The notification row is an optional settings capability and is injected
/// only by the mobile shell. The screen still lives here so its presentation
/// remains part of the shared settings slice rather than a second shell copy.
class const NotificationSettingsView({
  super.key,
