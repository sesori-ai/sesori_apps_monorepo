...
| Aspect | Contract |
|---|---|
| Source | `VoiceInputCubit` carries the composer session’s `confirmedText` and `provisionalText` preview in recording/transcribing state; presentation never subscribes to transport or platform services directly. |
