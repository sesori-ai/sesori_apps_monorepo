...
class LoginPolling implements LoginState {
  const LoginPolling({required this.handoff});
  

 final  LoginHandoff handoff;
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is LoginPolling&&(identical(other.handoff, handoff) || other.handoff == handoff));
}


@override
int get hashCode {
    return Object.hash(runtimeType,handoff);
}

@override
String toString() {
    return 'LoginState.polling(handoff: $handoff)';
}
...
/// Create a copy of LoginState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? handoff = null,}) {
  return _then(LoginPolling(
handoff: null == handoff ? _self.handoff : handoff // ignore: cast_nullable_to_non_nullable
as LoginHandoff,
  ));
}
