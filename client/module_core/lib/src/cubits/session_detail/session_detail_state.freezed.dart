...
as List<QueuedSessionPrompt>,availableAgents: null == availableAgents ? _self._availableAgents : availableAgents // ignore: cast_nullable_to_non_nullable
...
as List<SessionVariant>,retryErrorMessage: freezed == retryErrorMessage ? _self.retryErrorMessage : retryErrorMessage // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
