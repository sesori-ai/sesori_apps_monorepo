...
@JsonKey() final  DeviceCanvasSessionState deviceCanvas;
...
as List<QueuedSessionPrompt>,awaitingBridgeSubmissions: null == awaitingBridgeSubmissions ? _self._awaitingBridgeSubmissions : awaitingBridgeSubmissions // ignore: cast_nullable_to_non_nullable
...
as List<SessionVariant>,deviceCanvas: null == deviceCanvas ? _self.deviceCanvas : deviceCanvas // ignore: cast_nullable_to_non_nullable
as DeviceCanvasSessionState,
  ));
}
