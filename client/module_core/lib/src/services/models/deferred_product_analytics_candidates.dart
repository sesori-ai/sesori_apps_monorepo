...
final class DeferredProductAnalyticsCandidates {
  ...
  List<ProductAnalyticsEnvelope> get envelopes => [
    if (_activation case _DeferredProductAnalyticsCandidateRetained(:final envelope)) envelope,
    if (_projectAvailable case _DeferredProductAnalyticsCandidateRetained(:final envelope)) envelope,
    if (_diffAdoption case _DeferredProductAnalyticsCandidateRetained(:final envelope)) envelope,
    if (_sessionActivity case _DeferredProductAnalyticsCandidateRetained(:final envelope)) envelope,
  ];
