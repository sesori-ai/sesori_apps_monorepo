...
class _NewSessionOptionsData implements NewSessionOptionsData {
  const _NewSessionOptionsData({required final  List<AgentInfo> agents, required final  List<ProviderInfo> providers, required final  List<CommandInfo> commands, required this.selectedAgent, required this.selectedAgentModel, required this.stagedCommand, required final  List<SessionVariant> availableVariants}): _agents = agents,_providers = providers,_commands = commands,_availableVariants = availableVariants;
