...
@lazySingleton
class SessionService({required SessionRepository repository}) {
  ...
  Future<ApiResponse<void>> markSessionSeen({required String sessionId, required bool read}) {
    return _repository.markSessionSeen(sessionId: sessionId, read: read);
  }
  ...
  Future<ApiResponse<PendingPermissionResponse>> getPendingPermissions({required String sessionId}) {
    return _repository.getPendingPermissions(sessionId: sessionId);
  }
