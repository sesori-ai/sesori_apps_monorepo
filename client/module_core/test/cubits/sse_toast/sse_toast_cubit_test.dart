  ...
  group("SseToastCubit", () {
    ...
    blocTest<SseToastCubit, SseToastState>(
      ...
      act: (cubit) {
        events.add(
          const SseEvent(
            data: SesoriSseEvent.tuiToastShow(title: "Pi login required", message: "Run /login", variant: "warning"),
          ),
        );
        events.add(
          const SseEvent(
    ...
    blocTest<SseToastCubit, SseToastState>(
      ...
      act: (cubit) => events.add(
        const SseEvent(data: SesoriSseEvent.tuiToastShow(title: "Notice", message: "  ", variant: "sparkle")),
      ),
      expect: () => const [
    ...
    blocTest<SseToastCubit, SseToastState>(
      ...
      build: buildCubit,
      act: (cubit) {
        events.add(const SseEvent(data: SesoriSseEvent.tuiToastShow(title: null, message: null, variant: "error")));
        events.add(const SseEvent(data: SesoriSseEvent.tuiToastShow(title: " ", message: "", variant: null)));
        events.add(const SseEvent(data: SesoriSseEvent.projectUpdated(projectID: null, updatedAt: null)));
      },
