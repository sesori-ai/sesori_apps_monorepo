...
reset preserves an untouched source and leaves import retryable on relaunch, but
retires a source whose deletion already started rather than importing half of it.
