...
class _FakeShareClient() implements DesktopShareClient {
  ShareParams? params;
...
void main() {
  test("shares the original bytes and origin through the injected desktop client", () async {
    final bytes = Uint8List.fromList(const [1, 2, 3]);
    final client = _FakeShareClient();
    final sharer = DesktopImageSharer(shareClient: client);
