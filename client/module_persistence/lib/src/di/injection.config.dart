...
import 'package:sesori_persistence/src/api/secure_storage_api.dart' as _i558;
...
import 'package:sesori_persistence/src/foundation/persistence_scope.dart'
    as _i143;
import 'package:sesori_persistence/src/foundation/platform/master_key_store.dart'
    as _i394;
...
import 'package:sesori_persistence/src/repositories/persister_repository.dart'
    as _i865;
import 'package:sesori_persistence/src/repositories/secure_storage_repository.dart'
    as _i120;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i558.SecureStorageApi>(
      () => _i558.SecureStorageApi(
        database: gh<_i103.PersistenceDatabase>(),
        masterKeyStore: gh<_i394.MasterKeyStore>(),
      ),
    );
    gh.lazySingleton<_i120.SecureStorageRepository>(
      () => _i120.SecureStorageRepository(
        storageApi: gh<_i558.SecureStorageApi>(),
        cipher: gh<_i527.StorageCipher>(),
      ),
    );
