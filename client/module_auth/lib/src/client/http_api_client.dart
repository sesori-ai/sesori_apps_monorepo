...
@lazySingleton
class HttpApiClient(http.Client client) implements SafeApiClient {
...
final class const _JsonResponseParsingException({required this.message, required this.innerError}) implements Exception {
