...
- `GitCliApi` can stay a single git wrapper while its command methods live in a `part` file; that trims the main API wrapper under the file cap without splitting the external tool abstraction by use-case.
