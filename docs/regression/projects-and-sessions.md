...
- One scan is one row above the list, however many harnesses take part. Between
  ...
  cancel while it runs. Starting and running share the same PREGO loading-alert
  ...
  outcomes use the same 16px-inset, 69px PREGO result-card geometry with a 24px
  radius and iOS continuous corners: a success,
