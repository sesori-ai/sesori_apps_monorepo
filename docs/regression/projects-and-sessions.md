...
- A project identifier is stable and independent of its directory. A moved folder
  keeps identity, sessions, and overrides; an unknown identifier is never a path.
...
- A moved project appears new or empty, loses sessions, or resolves git in the
  old location.
