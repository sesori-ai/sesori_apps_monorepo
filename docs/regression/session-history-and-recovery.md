...
- On restored eligibility, the client refreshes history, options and pending input
  ...
  read-only with Retry and does not misreport a successful availability check.
