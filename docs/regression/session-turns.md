...
- A send or cancel succeeds against an archived session, an aborted turn
  ...
  or a trash action cancels another prompt or clears the draft. A native-dispatched
  prompt still offers trash, or a refused cancellation hides work as successfully
  cancelled before it later appears in the transcript. Delivered message
