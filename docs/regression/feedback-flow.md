...
- **Could be better** replaces the rating step with "What should we improve?".
  ...
  don’t arrive, App feels slow) and a text composer. Voice input is not part of
  this build.
...
- The composer and pills are locked while sending. On success the sheet closes,
  and "Feedback sent. Thank you!" appears once it has gone.
...
- **Cancel**, the close button, or a swipe down leaves without sending.
