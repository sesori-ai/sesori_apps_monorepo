...
- Private upgrade qualification must consume two retained successful native packaging
  ...
  record the process-owned status-item frame, require AXPress, hit-test beside the frame
  and invoke Quit only inside the anchored process-owned menu. Reject relaunch/orphans,
