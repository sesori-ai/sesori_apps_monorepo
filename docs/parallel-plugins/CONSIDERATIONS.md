...
> Status: **direction captured; implementation not started**. The durable
...
> re-verify every code reference because the implementation plan is deliberately
> deferred until the work starts.
