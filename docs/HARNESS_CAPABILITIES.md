...
full-root snapshot fanout, authoritative `turn_aborted` plus plugin settlement
for every selected target, and a surviving runtime. Live matrix is partial: no
